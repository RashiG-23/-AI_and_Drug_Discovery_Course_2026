...
Processed files were used for further Exploratory Chemical Analysis after 4 molecular descriptors (Molecular weight, Solubility, No. of hydrogen acceptors and No. of hydrogen donors) were calculated using RDkit. 
Total of 884 Pubchem Fingerprints were calculated using PaDELpy.
